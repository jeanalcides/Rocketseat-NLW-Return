...
export function WidgetForm() {
    ...
    return (
        <div className="bg-zinc-900 p-4 relative rounded-2xl mb-4 flex flex-col items-center shadow-lg w-[calc(100vw-2rem)] md:w-auto" >
            ...
            {feedbackSent ? (
                <FeedbackSuccessSteps onFeedbackRestartRequested={handleRestartFeedback} />
            ) : (
                <>
                    {!feedbackType ? (
            ...
            <footer className="text-xs text-neutral-400">
                Feito com amor por <a className="underline underline-offset-2" href="http://github.com/jeanalcides">JeanAlcides</a>
            </footer>
        </div>
    )
}